...
import { storageService, AdminUser } from "@/lib/storage-service"
...
export default function AdminPage() {
  ...
  useEffect(() => {
    const loadedUsers = storageService.getAdminUsers()
  ...
  const handleDelete = () => {
    if (selectedUsuario) {
      storageService.deleteAdminUser(selectedUsuario.id)
  ...
  const handleAddUser = (user: any) => {
    ...
    const savedUser = storageService.saveAdminUser(newUser)
