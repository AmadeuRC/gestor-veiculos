 ...
 * @param onCancel Callback chamado ao cancelar o formulário
 */
export function NovoCombustivelForm({ combustivel, onSuccess, onCancel }: NovoCombustivelFormProps) {
  ...
  function onSubmit(data: FormValues) {
    ...
    try {
      if (onSuccess) {
        // Passar os dados para o componente pai sem timeout
        onSuccess(data)
      }
    } finally {
      setIsLoading(false)
