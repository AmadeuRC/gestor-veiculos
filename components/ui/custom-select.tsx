...
// Versão personalizada do SelectItem que evita o problema de key
...
>(({ className, children, textValue, ...props }, ref) => {
  // Usar um textValue ou o children como texto
  ...
  return (
    <SelectPrimitive.Item
      ...
      {...props}
      // Aplicar o textValue explicitamente para evitar duplicação no DOM
    ...
    >
      ...
      {/* Usar span direto em vez de SelectPrimitive.ItemText para evitar problemas de key */}
      <span className="text-sm" key={`text-${props.value}`}>
        {children}
      </span>
    </SelectPrimitive.Item>
  );
